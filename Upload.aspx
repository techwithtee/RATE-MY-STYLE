...
<script runat="server">
          ...
          protected void btnSubmit_Click(Object s, EventArgs e)
          {
              ...
              {
                  cn.Open();
                  OleDbCommand Reg = new OleDbCommand("INSERT INTO Garments1( [Item], [Colour], [Shop], [Price], [Image]) VALUES (@Item, @Colour, @Shop, @Price, @Image)", cn);
